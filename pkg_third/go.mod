...
require (
	...
	github.com/am-okalin/kit v0.0.0-20241226083417-cbb453801839
...
require (
	...
	github.com/r0busta/go-shopify-graphql-model/v3 v3.0.1 // indirect
	github.com/r0busta/graphql v1.2.0 // indirect
